...
include ("../seguridad/seguridad.php");
 include("../conex.php");
       $cad="select * from usuario where idRol=1";
    ...
    <body style="background-image: url('imgen1.jpg');" >
      ...
      <div class="row">
            <div class="col-lg-12 text-center">
              <h1 class="well">Administracion de Estudiantes</h1>
            </div>
          </div>
        <table class="table table-bordered">
          ...
          <?php 
           ...
           <tr>
             ...
             <td class="text-center"><a href="editar_usuario.php?idUsu=<?php echo $fila['idUsu'];?>& 
           nombre=<?php echo $fila['nombreUsu'];?>&
            apellido=<?php echo $fila['apellidoUsu'];?>&
             ...
             <td class="text-center"><a href="proceso_eliminar_usuario.php?idUsu=<?php echo $fila['idUsu']; ?>" class="btn btn-warning" onclick="return confirm('Esta seguro que desea eliminar')" >Eliminar</a></td>
           </tr>
           <?php 
              }
            ?>
