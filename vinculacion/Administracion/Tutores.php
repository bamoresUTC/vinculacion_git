    ...
    <body style="background-image: url('imgen1.jpg');" >
        ...
        <div class="container" style="background: #2c3e50; height: 143px;padding:30px;color:#fff;width: 1360px;">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a class="btn btn-info" style="color: white;"  href="insertarUsuarios.php">Nuevo Usuario</a></li>
            </ul>
          </div> <br>
      ...
      <div class="row">
            <div class="col-lg-12 text-center">
              <h1 class="well">Administracion de Usuarios</h1>
            </div>
          </div>
        <table class="table table-bordered">
          ...
          <?php 
           ...
           <tr>
             ...
             <td class="text-center"><a href="editar_tutor.php?idUsu=<?php echo $fila['idUsu'];?>& 
           nombre=<?php echo $fila['nombreUsu'];?>&
            apellido=<?php echo $fila['apellidoUsu'];?>&
             ...
             <td class="text-center"><a href="proceso_eliminar_tutor.php?idUsu=<?php echo $fila['idUsu']; ?>" class="btn btn-warning" onclick="return confirm('Esta Seguro que desea eliminar ?');">Eliminar</a></td>
           </tr>
           <?php 
              }
            ?>
