				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="row text-center">
							<form action="proceso_registro_usuarios.php" method="POST" class="form-horizontal">
							...
							<div class="form-group"> 
								<label for="Nombre" class="col-lg-3 control-label">Clave</label>
								 <div class="col-lg-6">
								  <input  class="form-control" placeholder="ingrese password"  name="clave" id="txtpwd"required  type="password">
                                         </div>
							</div>
								<div class="form-group"> 
								<label for="Nombre" class="col-lg-3 control-label">Repita Clave </label>
								 <div class="col-lg-6">
								 <input  class="form-control" placeholder="repita password"  name="claver" id="txtrepitapwd"required  type="password">
      </div>
							</div>
							<div class="form-group "> 
								<div class=" col-lg-12">
