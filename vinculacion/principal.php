            ...
            <div class="col-md-12">
                <div class="text-center">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../vinculacion/Administracion/login.php">Solicitudes</a></li>
                            <li><a href="../vinculacion/Administracion/login.php">Informes</a></li>             
                        </ul>
                    </div>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../vinculacion/Administracion/formulario.php">Estudiante</a></li>
                            
                           
                        </ul>
                    </div>
                    <div class="btn-group">
                        <a class="btn btn-success dropdown-toggle"  href="../vinculacion/Administracion/login.php">Matricularse</a>
                      
                    </div>
                    <div class="btn-group">
                        <a href="../vinculacion/Administracion/login.php" class="btn btn-info dropdown-toggle" >INICIAR SESION</a>
                                          </div>
                </div>
            </div>
        </div>
    ...
    <div id="content">
      <div class="border_box">
        <div class="box_skitter box_skitter_large">
          <ul>
            <li><a href="#cube"><img src="images/example/001.png" class="circles" /></a><div class="label_text"><p>cube</p></div></li>
            <li><a href="#cubeRandom"><img src="images/example/002.png" class="circlesInside" /></a><div class="label_text"><p>cubeRandom</p></div></li>
            <li><a href="#block"><img src="images/example/003.png" class="circlesRotate" /></a><div class="label_text"><p>block</p></div></li>
            <li><a href="#cubeStop"><img src="images/example/004.png" class="cubeShow" /></a><div class="label_text"><p>cubeStop</p></div></li> 
          </ul>
        </div>
      </div>
    </div>
